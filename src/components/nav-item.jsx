...
export default function Navitem({ children, hovered, sethovered, slug }) {   
    ...
    return (
        <div onClick={()=>{navigates()}} onMouseEnter={() => sethovered(children)} onMouseLeave={() => sethovered('')} className='h-full flex flex-col justify-center cursor-pointer xl:text-[130%] lg:text-[115%] md:text-[100%]'>
            <h1>{children}</h1>
